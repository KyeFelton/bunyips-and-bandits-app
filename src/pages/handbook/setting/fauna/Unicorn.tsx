...
const content = (
  <>
    ...
    <p>
      Unicorns possess a single spiralled horn on the forehead, clooven hooves,
      and a mane that extends from the neck down the back to a ox-like tail.
      Their coats occur in various colours, including white, grey, chestnut, and
      black. They emit a faint, sweet scent, often compared to fresh grass or
      rain.
    </p>
    ...
    <p>
      ...
      Engloria, preferring regions with abundant water and vegetation. They are
      highly alert and avoid populated areas, often retreating into deep forests
      when threatened.
    </p>
    ...
    <p>
      Unicorns are herbivorous grazers that feed on grasses, herbs, flowers, and
      occasionally tree bark during winter. They are known to seek out mineral
      deposits, which contribute to the health and growth of their horns.
    </p>
    ...
    <p>
      ...
      born with a small nub of horn that begins to spiral within months. Mothers
      are protective and rear their young alone until maturity at around four
      years of age.
    </p>
