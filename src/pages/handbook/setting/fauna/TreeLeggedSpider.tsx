...
const content = (
  <>
    ...
    <p>
      ...
      Their long legs allow them to span between branches like part of the tree
      itself, motionless until the moment they attack.
    </p>
    ...
    <p>
      They are solitary and territorial, marking their arboreal ranges with silk
      strands so thin they resemble stray vines. They sway with the wind to
      enhance their disguise. While they rarely descend to the ground, legends
      tell of ancient individuals stalking whole clearings like moving thickets.
    </p>
  </>
);
