...
const content = (
  <>
    ...
    <p>
      Devil dogs are medium-sized marsupials standing around 1m at the shoulder,
      with compact, muscular bodies and short, thick limbs. Their fur is coarse
      and black, sometimes with white markings along the chest and flanks. They
      emit a strong, musky odour, particularly noticeable during feeding or
      aggression displays. The head is broad with powerful jaws capable of
      crushing bone. Devil dogs are best known for their piercing screeches and
      cackling calls, which can be heard over long distances.
    </p>
    ...
    <p>
      ...
      forests, grasslands, and open savannahs. They prefer areas with access to
      burrows or rocky shelters where they can establish communal dens. These
      dens are large, complex tunnel systems used for resting, rearing young,
      and sheltering from the heat of the day. They are primarily nocturnal,
      emerging at dusk to hunt.
    </p>
    ...
    <p>
      ...
      strong digestive systems allow them to consume bones and sinew as well as
      flesh.
    </p>
    ...
    <p>
      ...
      feed. Within the pack, dominance hierarchies are established through vocal
      contests rather than physical combat. During daylight hours, packs rest
      together in their dens, often emerging only at dusk.
    </p>
  </>
);
