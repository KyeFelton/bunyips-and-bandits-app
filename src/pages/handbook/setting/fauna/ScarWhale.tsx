...
const content = (
  <>
    ...
    <p>
      Scar whales possess elongated, muscular bodies with thick, dark grey skin
      marred by pale scars. Their heads are broad and reinforced with bony
      ridges used for ramming prey or defending territory. They have several
      rows of sharp, conical teeth and small eyes adapted for deep-sea hunting.
      Their vocalisations include low-frequency bellows and rapid clicking used
    ...
    <p>
      ...
      of large schools of fish or sea mammals, surfacing infrequently and diving
    ...
    <p>
      ...
      hunters, using coordinated strikes and ambush tactics to overwhelm larger
      prey. Calving occurs once every few years, and mothers are known to defend
      their young with extreme aggression.
    </p>
  </>
);
