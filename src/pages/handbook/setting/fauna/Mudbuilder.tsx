...
const content = (
  <>
    ...
    <p>
      Mudbuilders measure approximately ten centimetres across and possess flat,
      oval-shaped bodies covered in a smooth, grey-brown carapace that blends
      with their environment. Their claws are proportionally large and adapted
      for shaping and compacting mud. Two forward-facing eyes protrude on short
      stalks, capable of independent movement. When communicating psychically,
      their eyes produce a dull bioluminescent, purple glow.
    </p>
    ...
    <p>
      ...
      throughout Downunda. They construct communal mounds made from layered mud
      and plant matter, which can reach up to a metre in height. These
      structures contain a network of tunnels and chambers that remain cool and
      moist even during low tide. Settlements often consist of dozens of mounds
      clustered together along tidal flats.
    </p>
