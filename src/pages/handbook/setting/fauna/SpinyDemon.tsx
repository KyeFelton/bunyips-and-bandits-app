...
const content = (
  <>
    ...
    <p>
      ...
      spines across their bodies. Their skin varies in shades of sandy beige and
      red to blend with arid landscapes. Their head is squat with black eyes
      capable of expelling acidic blood as a defensive measure. Massive clawed
      feet and a muscular tail enable them to traverse rocky terrain and dig
      shallow basins for resting.
    </p>
    ...
    <p>
      These creatures feed mainly on tough desert shrubs, succulents, and roots,
      using a powerful beak-like jaw to shear through fibrous plants. Their
      spines collect dew from the air, channelling moisture toward their mouths,
      allowing them to survive in extreme drought.
    </p>
