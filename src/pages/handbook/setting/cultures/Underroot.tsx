...
const content = (
  <>
    ...
    <p>
      ...
      been eradicated by the Swarm. Only a few communities have survived due to
      the fact that they are mostly underground or underwater, and have hidden
      from the wrath of Malvada's forces.
    </p>
    ...
    <p>
      ...
      the soil with nutrients and breathed air into the sky. It then dropped the
      most glorious fruits. From the flesh of the fruits came the first animals,
      and the seeds sprouted into all kinds of exotic trees. A great forest was
      born.
    </p>
    ...
    <p>
      ...
      all-knowing due to its age, reach across the world and impeccable memory.
      The Underroot believe it is their duty to protect and worship the Ancestor
      Tree and the forests it created.
    </p>
    <p>
      ...
      Tree will telepathically speak back one word in response to the prayer. In
      rare circumstances, Darani will share a vision with its subject. Those
      that receive a visions are believed to be gifted.
    </p>

    <h3>Meditation</h3>

    <p>
      The Underroot place a high emphasis on their psychic aptitude as it brings
      them closer to Darani and helps defend themselves from threats,
    ...
    <p>
      ...
      of life. The spirits of the dead can then join with Darani to become one.
    </p>
    <p>
    ...
    <p>
      ...
      entrances to Underroot towns are typically concealed by vegetation, lakes
      or waterfalls to elude detection by the Swarm. Because of the lack of
      airflow, the towns contain various air channels to disperse carbon dioxide
      and heat.
    </p>
    ...
    <p>
      The Underroot have cultivated various species of algae that are harvested
      for food and textiles. Grubs are also bred as livestock and consumed as a
      delicacy.
    </p>
  </>
);
