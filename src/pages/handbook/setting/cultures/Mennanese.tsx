...
const content = (
  <>
    ...
    <p>
      ...
      bands or small caravans that move seasonally between oases and trade hubs.
    </p>
    <p>
    ...
    <p>
      Around a century ago, the region briefly unified under the Dynasty of the
      Sun Emperor, a Trunkird ruler said to possess extraordinary sorcery. The
      dynasty established several fortified oasis cities and a network of trade
      routes that brought wealth to the desert. Following the Emperor's death,
      his heirs fought over succession, leading to the fragmentation of the
      realm and the return to traditional nomadic structures. The ruins of these
      early desert cities remain as pilgrimage and trading sites.
    </p>
    ...
    <p>
      ...
      world. Next the Creator formed the first creatures known as the Avatars to
      help uphold order and take care of the new world. Finally, the Creator
      made the animals and plants of the world.
    </p>
    ...
    <p>
      Azmiorth's thirst for blood continued as he captured, killed and consumed
      more of his siblings to build his empire. In his rampage he destroyed the
      sun, casting the world into a shadow. When the Void became aware of the
      treachery, they along with the other Avatars fought a cataclysmic war to
      defeat Azmiorth and his army. They prevailed and Azmiorth was defeated.
      The Void then created the Eternal Prison, an ethereal plane of
      nothingness, and imprisoned Azmiorth there.
    </p>
    <p>
      To repopulate the world without causing another catastrophe, the Void
      granted the remaining Avatars the power to create life and bring balance.
      The Avatars then populated the world with new life to help restore the
      world from the destruction of the war.
    </p>
    <p>
    ...
    <p>
      ...
      treated as an equal. It is illegal to harm or eat trunkirds, and they are
      given food and water before all other domestic animals.
    </p>
    ...
    <p>
      ...
      conditions. Garments are loose-fitting and layered to allow airflow while
      protecting against sun and sand. Light, breathable fabrics such as linen
      and woven fibres are commonly used.
    </p>

    <h2>Architecture</h2>

    <p>
      Permanent structures are rare outside major oases. Temporary camps consist
      of tents made from woven cloth and animal hides, supported by wooden or
      bone frames. These are easily assembled and dismantled to accommodate
      nomadic travel.
    </p>
    <p>
      Oasis settlements and caravanserais feature low, rectangular buildings
      constructed from sun-dried bricks or carved stone. Thick walls and narrow
      windows help regulate interior temperature, and flat roofs are used for
      sleeping during cool nights. Public wells and shaded courtyards serve as
    ...
    <p>
      ...
      architectural remnants demonstrate the influence of past dynastic rule and
      stand as monuments amid the desert expanse.
    </p>
    ...
    <p>
      ...
      transportation, hauling, and carrying supplies across long distances. They
      are also bred for eggs, which form a significant portion of the Mennanese
      diet.
    </p>
  </>
);
