...
const content = (
  <>
    ...
    <p>
      Social structure is based around extended families and community councils,
      which manage local resources, mediate disputes, and organise collective
      work such as harvests or hunts. Elders are held in high esteem for their
      experience and ability to interpret omens and seasonal cycles.
    </p>
    ...
    <p>
      ...
      temperatures. Layers of fur, leather, and wool are worn throughout most of
      the year. Coats, hoods, and mittens made from the hides of woolly rhinos
      and tundra elk are common. Decorative embroidery and dyed thread are used
      along hems and collars to indicate family lineage or regional identity.
    </p>
    <p>
      Footwear consists of thick boots lined with fur or moss for warmth. Metal
      clasps and leather bindings are used to secure clothing, as buttons and
      ties are impractical in cold conditions.
    </p>
    ...
    <p>
      ...
      snow, with thick walls and steeply pitched roofs designed to shed snow and
      retain heat.
    </p>
    <p>
    ...
    <p>
      Public halls and fortresses are often decorated with carved wooden motifs
      depicting local myths and protective spirits. Despite the utilitarian
      design, Tolrusian architecture conveys a strong sense of endurance and
    ...
    <p>
      ...
      insulated garden plots. Greenhouses constructed from wood and oiled hides
      extend the growing period in some communities.
    </p>
    <p>
      Animal husbandry is central to Tolrusian sustenance and transport. Woolly
      rhinos are bred for multiple purposes, including riding, hauling, and
      providing meat, milk, and hides. Their thick fur and strength make them
      indispensable to rural households. Some communities also keep elk and
      goats for meat and diary.
    </p>
    <p>
      ...
      While they remain semi-independent, Tolrusian lynxes are valued for their
      loyalty and agility. Trained ravens are also kept for communication and
      reconnaissance between settlements.
    </p>
  </>
);
