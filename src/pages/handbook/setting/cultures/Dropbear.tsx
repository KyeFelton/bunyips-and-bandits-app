...
const content = (
  <>
    <p>
      ...
      Each clan is led by a patriarch called a boss, who has proven their might
      in a clan fighting contest. The boss takes all females in the clan to be
      his wife. No other male drop bear is permitted to father children
    ...
    <p>
      Being arboreal creatures, Drop Bears prefer to be in the forest and build
      their homes in tree canopies. They are known for hiding in trees and
      pouncing on prey from above. Because they rely on taking food and
