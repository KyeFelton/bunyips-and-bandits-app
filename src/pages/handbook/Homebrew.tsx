  ...
  <>
    ...
    <Body>
      <p>
        ...
        documentary or a field guide. Descriptions stick to observable facts
        and measurable details. The world speaks through concrete specifics, not
        emotional language or narrative flourishes.
      </p>
      <ul className="list-disc ml-4">
        <li>
          Present tense for all descriptions and current states. Past tense
      ...
      <p>
        All text uses Australian English. "Colour" not "color." "Summarise"
        not "summarize." "Defence" not "defense."
      </p>
      <Blockquote>
        The Birim are a reptilian folk originating from the deserts of
        Downunda. They are distinguished by their tall and slender physique,
        with features resembling goannas. Their build allows them to move
        through narrow gaps and rocky terrain with ease.
      </Blockquote>
    </Body>
    <H3>Creating Folk</H3>
    <Body>
      ...
      <ul className="list-disc ml-4">
        ...
        <li>
          <b>Habitat and settlements.</b> Where they live, what their housing
          is like.
        </li>
        <li>
    ...
    <Body>
      ...
      <ul className="list-disc ml-4">
        ...
        <li>
          <b>Habit.</b> Habitat details, den or lair descriptions, active
          hours.
        </li>
        <li>
    ...
    <Body>
      <ul className="list-disc ml-4">
        ...
        <li>
          <b>Encounter (if relevant).</b> Game mechanics for player
          interaction.
        </li>
      </ul>
    </Body>
