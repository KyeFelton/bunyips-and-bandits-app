  ...
  <>
    <Body>
      ...
      <p>
        ...
        into unexpected dangers, and have to think on your feet to survive. Your
        choices shape the story, and the dice determine whether things go to
        plan or take a turn for the worse.
      </p>
      <Callout variant="warning">
        ...
        lost. The weight of these tragedies is still felt by Aboriginal and
    ...
    <Body>
      ...
      <ul className="list-disc ml-4">
        <li>
          ...
          case—just clear intent and the expectation that the table will sort it
          out.
        </li>
        <li>
    ...
    <Body>
      ...
      <p>
        ...
        polyhedral dice set: d4, d6, d8, d12, and d20. The GM may also want a
        board to track character positions during combat, though theatre of the
        mind works just as well.
      </p>
    </Body>
  </>
);
