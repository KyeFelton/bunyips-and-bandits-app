...
const content = (
  <>
    ...
    <p>
      ...
      Freshwater Nawnaw are generally smaller in size and darker in colouration,
      adapted to rivers, lakes, and inland waterways. Marine Nawnaw, by
      contrast, are larger and lighter in tone, suited to open ocean conditions.
      While either race can survive in the other's environment, the process
      requires gradual acclimatisation over the course of about a week, allowing
      their physiology to adjust to changes in salinity and pressure.
    </p>
    <p>
      Nawnaw are often regarded as disciplined and authoritative, serving as
      guardians of waterways and reefs. Their culture places emphasis on order,
      duty, and the preservation of aquatic environments, with leadership roles
      commonly held by those demonstrating exceptional strength or wisdom.
    </p>
  </>
);
