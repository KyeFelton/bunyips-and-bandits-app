...
const content = (
  <>
    ...
    <p>
      ...
      trees, cliff faces, or mountainsides. Their homes are makeshift in nature,
      constructed from wood, rope, and available natural materials. These
      structures often look wonky but somehow hold strong. They are often
      expanded upon over time as communities grow and shift.
    </p>
    <p>
