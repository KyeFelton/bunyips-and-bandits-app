...
const content = (
  <>
    <p>
      ...
      signifying lineage or spiritual practice. Traditional clothing consists of
      draped fabrics, sashes, and arm bands suited to the warm climate of their
      homeland.
    </p>
    <p>
      Ardhasura settlements are commonly built near rivers, plateaus, or sacred
      sites. Their architecture favours carved stone and monumental design, with
      open courtyards and tiered temples forming the centre of community life.
      Many communities maintain ancient traditions of stonecraft, sculpture, and
      ceremonial art, reflecting both practical and spiritual aspects of their
      culture.
    </p>
    <p>
