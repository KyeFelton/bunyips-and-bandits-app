...
const content = (
  <>
    <p>
      Their clothing is crafted from shells and pearls bound together with roots
      and other natural fibres.
    </p>
    <p>
      Joonyar communities are established in subterranean networks beneath
      forests and coastal areas. Their dwellings are carved into soil and stone,
      reinforced with woven roots and lined with polished shells. Many tunnels
      connect to underground springs or openings near riverbanks, enabling trade
      and exchange with surface dwellers. Collections of natural items such as
      shells, pearls and minerals are commonly displayed within their homes.
    </p>
    <p>
