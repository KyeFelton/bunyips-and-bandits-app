...
const content = (
  <>
    <p>
      They are typically adorned in refined silk garments, often richly coloured
      and decorated with intricate patterns.
    </p>
    <p>
    ...
    <p>
      ...
      societies are structured around apprenticeship and mastery of trade, with
      cultural value placed on refinement and precision.
    </p>
  </>
);
