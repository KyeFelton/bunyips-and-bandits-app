...
const content = (
  <>
    ...
    <p>
      Wattalang are often regarded as peaceful and attentive caretakers of their
      environment. Their culture places emphasis on ecological balance, renewal,
      and cooperation with other forest-dwelling folk.
    </p>
  </>
);
