import { Blockquote, WikiPage } from "../../../components/WikiPage";
...
const main = (
  <>
    <p>
      ...
      New folk, fauna, places, and adventures can be created by anyone, drawing
      on other cultures and traditions from around the world. The handbook
      provides a shared framework to keep new creations consistent with the
    ...
    <p>
      ...
      without needing to catch up on years of history. That said, episodes don't
      have to stand alone—stories can be linked together into a longer, more
      complex narrative if that's what your group commits to.
    </p>

    <h3>The World's Voice</h3>
    <p>
      All lore in Bunyips and Bandits is written in an encyclopedic
      voice—objective, informative, and grounded. Think of a nature documentary
      or a field guide. Descriptions stick to observable facts and measurable
      details. The world speaks through concrete specifics, not emotional
      language or narrative flourishes.
    </p>
    <ul className="list-disc ml-4">
      ...
      <li>
        Specific, concrete details over vague impressions. No flowery or poetic
        language.
      </li>
    </ul>
    <p>
    ...
    <ul className="list-disc ml-4">
      <li>
        <b>Opening paragraph.</b> Species type, habitat, key threat or feature.
      </li>
      <li>
        <b>Description.</b> Physical appearance, size with measurements, notable
        features, sounds or smells.
      </li>
      <li>
      ...
      <li>
        <b>Behaviour.</b> Social structure, hunting tactics, mating, territorial
        behaviour.
      </li>
      <li>
    ...
    <ul className="list-disc ml-4">
      ...
      <li>
        <b>Description (if detailed).</b> Physical features, notable buildings.
      </li>
      <li>
    ...
    <ul className="list-disc ml-4">
      <li>
        <b>Opening paragraph.</b> Gender, ancestry, role or title, affiliation.
      </li>
      <li>
