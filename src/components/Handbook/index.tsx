...
import { Content, H2, H3, Page } from "../Wiki/Page";
  ...
  <>
    ...
    <Content>
      <p>
        ...
        surrender, they lose the combat. The victorious party chooses whether to
        kill, capture or leave the losers in their place. If the players lose
        the combat, it’s up to the GM to decide their fate.
      </p>
      <p>
...
export function Handbook() {
  return (
    ...
    >
      <Page title="Handbook" summary={summary} content={content} />
    </motion.div>
  );
}
