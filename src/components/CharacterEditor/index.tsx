...
export const CharacterEditor = () => {
  ...
  return (
    <div className="h-screen bg-muted p-8">
      <div className="max-w-4xl mx-auto space-y-8 h-full flex flex-col">
        ...
        {/* Progress Bar */}
          <div className="flex relative">
           <div className="absolute top-2 w-full h-0.5 bg-muted-foreground/20" style={{ width: '80%', left: '10%', right: '10%' }}>
             <div
        ...
        {/* Navigation */}
        <div className="flex justify-between pt-8" style={{ marginTop: "auto"}}>
          <Button
            variant="outline"
